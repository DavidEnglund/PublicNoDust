...
namespace Dustbuster
{
    public class DbConnectionManager
    {
		...
		private List<ProductDescription> productDescriptions = new List<ProductDescription>
        {
            ...
            new ProductDescription(2, 180,"1 App/3 weeks", 150, "DustLig","DustLig is a sodium lignosulphonate derived from the wood pulp industry. It is a cheap, short term dust suppression, mainly used to achieve protection from wind erosion. Because it is water soluble re-application will be required after any rain event. Without rain it is suggested to re-apply every 2 to 3 weeks for optimal protection."),
