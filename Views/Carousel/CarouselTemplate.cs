...
namespace Dustbuster
{
    class CarouselTemplate : ContentView
    {
        ...
        private void SetBindings()
        {
            ...
            lblQuantity.SetBinding(Label.TextProperty, new Binding("Concentration", stringFormat: "You will need {0} amount per application"));
            ...
            lblRate.SetBinding(Label.TextProperty, new Binding("ApplicationsRequired", stringFormat: "The application rate is {0}"));
